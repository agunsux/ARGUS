...
- **Aksi:** Founder mencari penjual tiket di platform sosial (Twitter, Telegram) yang kesulitan menjual tiketnya karena pembeli ragu. Tawarkan ARGUS sebagai pihak ketiga (Escrow + Verifikasi) secara gratis (atau diskon *fee*) untuk batch pertama.
...
- **Milestone:** Pembeli bisa melihat katalog tiket tervalidasi secara *real-time* tanpa harus bertanya via WA apakah tiket masih tersedia. Target mencapai **50 VOT**.
