  ...
  _initializeDefaultSources() {
    const defaults = [
      ...
      // ==========================================
      {
        ...
        notes: 'Primary verified channel for K-Pop and global artists'
      },
      {
        source_id: 'src-promoters-official',
        source_name: 'Official Promoters Network (APMI & Premier Promoters)',
        source_type: SOURCE_TYPES.OFFICIAL_PROMOTER_WEB,
        tier: 1,
        authority_level: 'HIGH',
        base_url: 'https://apmi.id',
        country: 'Indonesia',
        language: 'id',
        coverage: 'NATIONAL',
        category: 'MUSIC',
        ...
        permission_status: PERMISSION_STATUS.AUTHORIZED_API,
        terms_reference: 'Official Promoter Association Feed',
        robots_policy: 'HONOR_ROBOTS_TXT',
        ...
        trust_level: TRUST_LEVELS.TIER_1,
        active_status: SOURCE_STATUS.ACTIVE,
        notes: 'Official aggregator feed for PK Entertainment, Dyandra, Color Asia, etc.'
      },
      {
        source_id: 'src-gov-calendar',
        source_name: 'Kemenparekraf / Karisma Event Nusantara (Official Gov Calendar)',
        source_type: SOURCE_TYPES.GOVERNMENT,
        tier: 2,
        authority_level: 'MEDIUM',
        base_url: 'https://kemenparekraf.go.id',
        country: 'Indonesia',
        language: 'id',
        coverage: 'NATIONAL',
        category: 'FESTIVAL',
        ...
        access_method: ACCESS_METHODS.PUBLIC_DISCOVERY_ONLY,
        permission_status: PERMISSION_STATUS.AUTHORIZED_API,
        terms_reference: 'Public Tourism Calendar',
        robots_policy: 'HONOR_ROBOTS_TXT',
        rate_limit: '30 req/min',
        crawl_frequency: CRAWL_FREQUENCY.DAILY,
        priority: 2,
        ...
        active_status: SOURCE_STATUS.ACTIVE,
        notes: 'Official government tourism & creative economy event calendar'
      },
      {
      ...
      {
        source_id: 'src-yeezy-tour',
        source_name: 'Yeezy Official Tour (Ye / Kanye West)',
        source_type: SOURCE_TYPES.OFFICIAL_ARTIST_WEB,
        tier: 1,
        authority_level: 'HIGH',
        base_url: 'https://tour.yeezy.com',
        country: 'Global',
        language: 'en',
        coverage: 'GLOBAL',
        category: 'MUSIC',
        ...
        access_method: ACCESS_METHODS.PUBLIC_DISCOVERY_ONLY,
        permission_status: PERMISSION_STATUS.AUTHORIZED_API,
        terms_reference: 'Official Artist Tour Platform (https://tour.yeezy.com/)',
        robots_policy: 'HONOR_ROBOTS_TXT',
        rate_limit: '30 req/min',
        crawl_frequency: CRAWL_FREQUENCY.DAILY,
        priority: 1,
        ...
        notes: 'Primary official tour channel for Ye / Kanye West (https://tour.yeezy.com/)'
      },
      {
        source_id: 'src-yeezy',
        source_name: 'Yeezy Official Tour (Ye / Kanye West)',
        ...
        active_status: SOURCE_STATUS.ACTIVE,
        can_mark_verified: true,
        notes: 'Primary official tour channel for Ye / Kanye West'
      },
      {
