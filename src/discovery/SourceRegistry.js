...
class SourceRegistry {
  ...
  _initializeDefaultSources() {
    const defaults = [
      // ==========================================
      // TIER 1: AUTHORITATIVE ARTIST CHANNELS & MANAGEMENTS
      // ==========================================
      {
        source_id: 'src-weverse',
        source_name: 'Weverse Official Notices (Global Artist Platform)',
        ...
        terms_reference: 'Official Artist Notice Channel',
        ...
        notes: 'Primary verified channel for K-Pop and global artists (NCT 127, BABYMONSTER, etc.)'
      },
      {
        source_id: 'src-yg-entertainment',
        source_name: 'YG Entertainment (Official Artist Management & Label)',
        source_type: SOURCE_TYPES.OFFICIAL_ARTIST_WEB,
        tier: 1,
        authority_level: 'HIGH',
        ...
        access_method: ACCESS_METHODS.PUBLIC_DISCOVERY_ONLY,
        permission_status: PERMISSION_STATUS.AUTHORIZED_API,
        terms_reference: 'Official Artist Management Portal',
        robots_policy: 'HONOR_ROBOTS_TXT',
        rate_limit: '30 req/min',
        crawl_frequency: CRAWL_FREQUENCY.DAILY,
        priority: 1,
        ...
        trust_level: TRUST_LEVELS.TIER_1,
        active_status: SOURCE_STATUS.ACTIVE,
        notes: 'Official label and management for BIGBANG, BABYMONSTER, etc.'
      },
      {
        source_id: 'src-promoter-dyandra',
        source_name: 'Dyandra Global Edutainment (Official Promoter / APMI Member)',
      ...
      {
        source_id: 'src-promoter-colorasia',
        source_name: 'Color Asia Live (Official Promoter / APMI Member)',
        source_type: SOURCE_TYPES.OFFICIAL_PROMOTER_WEB,
        tier: 1,
        authority_level: 'HIGH',
        base_url: 'https://colorasialive.com',
        country: 'Indonesia',
        language: 'id',
        coverage: 'NATIONAL',
        category: 'MUSIC',
        ...
        trust_level: TRUST_LEVELS.TIER_1,
        active_status: SOURCE_STATUS.ACTIVE,
        notes: 'Official promoter for The Script, Westlife, and major international tours'
      },
      {
        source_id: 'src-promoter-plainsong',
        source_name: 'Plainsong Live (Official Promoter)',
        source_type: SOURCE_TYPES.OFFICIAL_PROMOTER_WEB,
        tier: 1,
        authority_level: 'HIGH',
        base_url: 'https://plainsonglive.com',
        country: 'Indonesia',
        language: 'id',
        coverage: 'NATIONAL',
        category: 'MUSIC',
        ...
        trust_level: TRUST_LEVELS.TIER_1,
        active_status: SOURCE_STATUS.ACTIVE,
        notes: 'Official promoter for Men I Trust, Joyland Festival, and indie international tours'
      },
      {
        source_id: 'src-event-thescript-web',
        source_name: 'The Script Satellites Tour Jakarta Official Site',
        source_type: SOURCE_TYPES.OFFICIAL_EVENT_WEB,
        tier: 1,
        authority_level: 'HIGH',
        base_url: 'https://www.thescriptindonesia2026.com',
        country: 'Indonesia',
        language: 'id',
        coverage: 'NATIONAL',
        category: 'MUSIC',
        ...
        terms_reference: 'Official Event Website',
        robots_policy: 'HONOR_ROBOTS_TXT',
        rate_limit: '30 req/min',
        crawl_frequency: CRAWL_FREQUENCY.DAILY,
        priority: 1,
        ...
        trust_level: TRUST_LEVELS.TIER_1,
        active_status: SOURCE_STATUS.ACTIVE,
        notes: 'Official event website for The Script in Jakarta 2026'
      },
      {
        ...
        trust_level: TRUST_LEVELS.TIER_1,
        active_status: SOURCE_STATUS.ACTIVE,
        notes: 'Official promoter for DWP, We The Fest, Maddix, and international concerts'
      },
      {
        source_id: 'src-event-maddix-web',
        source_name: 'Maddix Official Tour Website',
        source_type: SOURCE_TYPES.OFFICIAL_EVENT_WEB,
        tier: 1,
        authority_level: 'HIGH',
        base_url: 'https://maddixmusic.com',
        country: 'Indonesia',
        language: 'en',
        coverage: 'NATIONAL',
        category: 'MUSIC',
        ...
        access_method: ACCESS_METHODS.PUBLIC_DISCOVERY_ONLY,
        permission_status: PERMISSION_STATUS.PUBLIC_DATA,
        terms_reference: 'Official Artist Tour Web',
        robots_policy: 'HONOR_ROBOTS_TXT',
        rate_limit: '30 req/min',
        crawl_frequency: CRAWL_FREQUENCY.DAILY,
        priority: 1,
        ...
        trust_level: TRUST_LEVELS.TIER_1,
        active_status: SOURCE_STATUS.ACTIVE,
        notes: 'Official tour dates portal for Maddix'
      },
      {
        source_id: 'src-event-toucheamore-web',
        source_name: 'Touché Amoré Official Tour Website',
        source_type: SOURCE_TYPES.OFFICIAL_EVENT_WEB,
        tier: 1,
        authority_level: 'HIGH',
        base_url: 'https://toucheamore.com',
        country: 'Indonesia',
        language: 'en',
        coverage: 'NATIONAL',
        category: 'MUSIC',
      ...
      // ==========================================
      {
        ...
        source_name: 'EKRAF Hub (Kementerian Ekonomi Kreatif RI)',
        source_type: SOURCE_TYPES.DISCOVERY_PLATFORM,
        tier: 3,
        authority_level: 'LOW',
        base_url: 'https://hub.ekraf.go.id',
        country: 'Indonesia',
        language: 'id',
        coverage: 'NATIONAL',
        category: 'GOVERNMENT',
        ...
        access_method: ACCESS_METHODS.PUBLIC_DISCOVERY_ONLY,
        permission_status: PERMISSION_STATUS.PUBLIC_DATA,
        terms_reference: 'Ministry Agenda Radar (Discovery Only - Cannot Solely Verify)',
        robots_policy: 'HONOR_ROBOTS_TXT',
        rate_limit: '30 req/min',
        crawl_frequency: CRAWL_FREQUENCY.DAILY,
        priority: 3,
        ...
        active_status: SOURCE_STATUS.ACTIVE,
        can_verify: false,
        notes: 'National agenda discovery radar; requires primary promoter/artist corroboration'
      },
      {
        source_id: 'src-pbsi',
        source_name: 'PBSI (Persatuan Bulutangkis Seluruh Indonesia)',
        source_type: SOURCE_TYPES.SPORTS_ORGANIZATION,
        tier: 2,
        authority_level: 'MEDIUM',
        base_url: 'https://pbsi.id',
        country: 'Indonesia',
        language: 'id',
        coverage: 'NATIONAL',
        category: 'SPORT',
        ...
        access_method: ACCESS_METHODS.PUBLIC_DISCOVERY_ONLY,
        permission_status: PERMISSION_STATUS.PUBLIC_DATA,
        terms_reference: 'National Badminton Federation Calendar',
        robots_policy: 'HONOR_ROBOTS_TXT',
        rate_limit: '30 req/min',
        ...
        active_status: SOURCE_STATUS.ACTIVE,
        notes: 'Official national badminton championship calendar'
      },
      {
        source_id: 'src-fpti',
        source_name: 'FPTI (Federasi Panjat Tebing Indonesia)',
        source_type: SOURCE_TYPES.SPORTS_ORGANIZATION,
        tier: 2,
        authority_level: 'MEDIUM',
        base_url: 'https://fpti.or.id',
        country: 'Indonesia',
        language: 'id',
        coverage: 'NATIONAL',
        category: 'SPORT',
        ...
        access_method: ACCESS_METHODS.PUBLIC_DISCOVERY_ONLY,
        permission_status: PERMISSION_STATUS.PUBLIC_DATA,
        terms_reference: 'National Sport Climbing Federation Calendar',
        robots_policy: 'HONOR_ROBOTS_TXT',
        rate_limit: '30 req/min',
        crawl_frequency: CRAWL_FREQUENCY.WEEKLY,
        priority: 2,
        ...
        trust_level: TRUST_LEVELS.TIER_2,
        active_status: SOURCE_STATUS.ACTIVE,
        notes: 'Official national sport climbing tournament calendar'
      },
      {
        source_id: 'src-tias-running',
        source_name: 'TIAS Kalender Lari Indonesia (Discovery Radar)',
        source_type: SOURCE_TYPES.DISCOVERY_PLATFORM,
        tier: 3,
        authority_level: 'LOW',
        base_url: 'https://tias.co.id',
        country: 'Indonesia',
        language: 'id',
        coverage: 'NATIONAL',
        category: 'SPORT',
        ...
        access_method: ACCESS_METHODS.PUBLIC_DISCOVERY_ONLY,
        permission_status: PERMISSION_STATUS.PUBLIC_DATA,
        terms_reference: 'National Running Events Radar',
        robots_policy: 'HONOR_ROBOTS_TXT',
        rate_limit: '30 req/min',
        crawl_frequency: CRAWL_FREQUENCY.WEEKLY,
        priority: 3,
        ...
        active_status: SOURCE_STATUS.ACTIVE,
        can_verify: false,
        notes: 'Running calendar radar; requires direct race organizer corroboration'
      },
      // ==========================================
      ...
      },
      {
        ...
        robots_policy: 'HONOR_ROBOTS_TXT',
        robots_url: 'https://www.loket.com/robots.txt',
      ...
      },
      {
        ...
        robots_policy: 'HONOR_ROBOTS_TXT',
        robots_url: 'https://bbo.co.id/robots.txt',
      ...
      },
      {
        ...
        terms_reference: 'Public Structured Event Feed',
        robots_policy: 'HONOR_ROBOTS_TXT',
        notes: 'Dominant platform for university concerts and regional festivals in Yogyakarta and Central Java. AUDITED: no robots.txt published (HTTP 404) and the public /explore catalog is a Next.js SPA with zero server-rendered event data or structured data, so there is no compliant discovery surface. Ingestion requires the official partner feed (ARTATIX_FEED_URL).'
      },
      {
      ...
      },
      {
        ...
        trust_level: TRUST_LEVELS.TIER_1,
        active_status: SOURCE_STATUS.ACTIVE,
        terms_reference: 'Official Promoter Public Event Calendar (robots.txt audited: only /myln, /subscription, /account, /culture, /health, /login, /register disallowed)',
        robots_policy: 'HONOR_ROBOTS_TXT',
        robots_url: 'https://www.livenation.asia/robots.txt',
        terms_url: 'https://www.livenation.asia/terms',
        rate_limit: '30 req/min',
        crawl_frequency: CRAWL_FREQUENCY.DAILY,
        priority: 1,
        reliability_score: 1.0,
        notes: 'Official Live Nation Asia promoter calendar (@livenationasia). Audited: public artist/event pages are server-rendered with per-event date, city, venue and event id, and poster art served from dynamicmedia.livenationinternational.com. Official event page URLs are preserved for attribution.'
      },
      {
        source_id: 'src-axs',
      ...
      },
      {
        ...
        authority_level: 'HIGH',
        source_role: SOURCE_ROLES.PRIMARY_EVENT_SOURCE,
        base_url: 'https://www.theweekndinjakarta.com',
        country: 'Indonesia',
        language: 'id',
        coverage: 'JAKARTA',
        category: 'CONCERT',
        ...
        trust_level: TRUST_LEVELS.TIER_S,
        active_status: SOURCE_STATUS.ACTIVE,
        terms_reference: 'Official Event Channel linked from the Live Nation Asia official event page',
        robots_policy: 'HONOR_ROBOTS_TXT',
        rate_limit: '30 req/min',
        crawl_frequency: CRAWL_FREQUENCY.DAILY,
        priority: 1,
        reliability_score: 1.0,
        notes: 'Official Indonesian event website for The Weeknd: After Hours Til Dawn Tour at Jakarta International Stadium (26 Sep 2026). Audited HTTP 200; referenced as the official ticketing information destination from https://www.livenation.asia/event/the-weeknd-after-hours-til-dawn-tour-jakarta-ticket-edp1672880'
      },
      {
        source_id: 'src-event-lanyinjakarta-web',
        source_name: 'LANY in Jakarta 2026 Official Event Website',
        source_owner: 'TEM Presents / Live Nation Asia',
        source_type: SOURCE_TYPES.OFFICIAL_EVENT_WEB,
        tier: 1,
        authority_level: 'HIGH',
        source_role: SOURCE_ROLES.PRIMARY_EVENT_SOURCE,
        base_url: 'https://www.lanyinjakarta2026.com',
        country: 'Indonesia',
        language: 'id',
        coverage: 'JAKARTA',
        category: 'CONCERT',
        ...
        priority: 1,
        reliability_score: 1.0,
        notes: 'Official Indonesian event website for LANY: soft world tour at Indonesia Arena - Senayan (29 & 30 Oct 2026). Audited HTTP 200 with title "LANY in Jakarta 2026"; referenced from https://www.livenation.asia/event/lany-soft-world-tour-jakarta-ticket-edp1666528'
      },
      {
        source_id: 'src-event-maroon5jakarta-web',
        source_name: 'Maroon 5 Asia 2027 Jakarta Official Event Website',
        source_owner: 'TEM Presents / Live Nation Asia',
        source_type: SOURCE_TYPES.OFFICIAL_EVENT_WEB,
        tier: 1,
        authority_level: 'HIGH',
        source_role: SOURCE_ROLES.PRIMARY_EVENT_SOURCE,
        base_url: 'http://maroon5jakarta2027.com',
        country: 'Indonesia',
        language: 'id',
        coverage: 'JAKARTA',
        category: 'CONCERT',
        ...
        priority: 1,
        reliability_score: 1.0,
        notes: 'Official Indonesian event website for Maroon 5 Asia 2027 in Jakarta at Jakarta International Stadium (5 Feb 2027). Audited HTTP 200 with title "Maroon 5 Asia 2027 - Jakarta"; referenced from https://www.livenation.asia/maroon-5-tickets-adp618'
      },
      {
        source_id: 'src-event-bigbangjakarta-web',
        source_name: 'BIGBANG in Jakarta Official Event Website',
        source_owner: 'YG Entertainment / Official Promoter',
        source_type: SOURCE_TYPES.OFFICIAL_EVENT_WEB,
        tier: 1,
        authority_level: 'HIGH',
        source_role: SOURCE_ROLES.PRIMARY_EVENT_SOURCE,
        base_url: 'https://bigbanginjakarta.com',
        country: 'Indonesia',
        language: 'id',
        coverage: 'JAKARTA',
        category: 'CONCERT',
        ...
        trust_level: TRUST_LEVELS.TIER_S,
        active_status: SOURCE_STATUS.ACTIVE,
        terms_reference: 'Official Event Channel confirmed by YG Entertainment',
        robots_policy: 'HONOR_ROBOTS_TXT',
        rate_limit: '30 req/min',
        crawl_frequency: CRAWL_FREQUENCY.DAILY,
        priority: 1,
        reliability_score: 1.0,
        notes: 'Official event website for BIGBANG 2026-27 WORLD TOUR in Jakarta at JIS (16-17 Jan 2027)'
      },
      {
      ...
      },
      {
        ...
        source_name: 'Live Nation Asia Instagram (@livenationasia)',
        source_owner: 'Live Nation Asia',
        source_type: SOURCE_TYPES.DISCOVERY_PLATFORM,
        tier: 3,
        authority_level: 'MEDIUM',
        source_role: SOURCE_ROLES.DISCOVERY_SIGNAL,
        base_url: 'https://www.instagram.com/livenationasia/',
        account_handle: '@livenationasia',
        canonical_account: '@livenationasia',
        country: 'International',
        language: 'en',
        coverage: 'INTERNATIONAL',
        category: 'MUSIC',
        ...
        trust_level: TRUST_LEVELS.TIER_3,
        active_status: SOURCE_STATUS.ACTIVE,
        terms_reference: 'Meta Terms of Service - automated collection prohibited',
        robots_policy: 'API_OR_MANUAL_REVIEW',
        priority: 3,
        reliability_score: 0.85,
        notes: 'Instagram handle of Live Nation Asia (@livenationasia). AUDITED: login-gated profile and Meta ToS prohibit automated collection, therefore NO scraping is performed. Registered as a Tier 3 discovery signal; every announcement is corroborated against the official Live Nation Asia public calendar (src-livenation) before an event becomes public.'
      },
      {
        source_id: 'src-ig-ticketmasterasia',
        source_name: 'Ticketmaster Asia Instagram (@ticketmasterasia)',
        source_owner: 'Ticketmaster Asia',
        source_type: SOURCE_TYPES.DISCOVERY_PLATFORM,
        tier: 3,
        authority_level: 'MEDIUM',
        source_role: SOURCE_ROLES.DISCOVERY_SIGNAL,
        base_url: 'https://www.instagram.com/ticketmasterasia/',
        account_handle: '@ticketmasterasia',
        canonical_account: '@ticketmasterasia',
        country: 'International',
        language: 'en',
        coverage: 'INTERNATIONAL',
        category: 'MUSIC',
        ...
        priority: 3,
        reliability_score: 0.8,
        notes: 'Instagram handle of Ticketmaster Asia (@ticketmasterasia). AUDITED: login-gated profile, Meta ToS prohibit automated collection, ticketmaster.asia DNS does not resolve and regional Ticketmaster hosts return HTTP 401, therefore NO scraping is performed. Registered as a Tier 3 discovery signal; verification requires the official Ticketmaster Discovery API (TICKETMASTER_API_KEY).'
      }
    ];
