...
const TRANSLATIONS = {
  id: {
    ...
    footer: {
      ...
      copyright: "© 2026 SHINERVA HQ. Hak cipta dilindungi undang-undang.",
  ...
  en: {
    ...
    footer: {
      ...
      copyright: "© 2026 SHINERVA HQ. All rights reserved.",
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-8 py-12">
              ...
              <div className="col-span-2 md:col-span-1">
                ...
                <ul className="space-y-2 text-xs">
                  ...
                  <li><a href="/refund-policy" className="hover:text-emerald-400 transition-colors">Refund Policy</a></li>
                ...
                <div className="mt-4 pt-3 border-t border-zinc-800 text-xs text-zinc-400 leading-relaxed">
                  <div className="font-semibold text-zinc-300">SHINERVA HQ</div>
                  <div>Jl. Pasirluyu No. 79</div>
                  <div>Bandung 40254, Indonesia</div>
                  <div>Email: <a href="mailto:agunsux@gmail.com" className="text-emerald-400">agunsux@gmail.com</a></div>
                  <div>WhatsApp: <a href="https://wa.me/6281299927378" target="_blank" rel="noopener noreferrer" className="text-emerald-400">081299927378</a></div>
                </div>
              </div>
            </div>
